...
const sig2 = await signOrderRFQ({
    ...
    order: {
        ...
        usePermit2: true,
        permit2Signature: "0x",
        permit2Witness: "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
        permit2WitnessType: "ExampleWitness(witness)"
    },
});
...
const sig3 = await signOrderRFQ({
    ...
    order: {
        ...
        permit2Signature: "0x",
        permit2Witness: "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
        permit2WitnessType: "ExampleWitness(address user)"
    },
});
